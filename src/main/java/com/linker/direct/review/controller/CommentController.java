...
public class CommentController {
	...
	public int commentInsert(@RequestParam Long review_no, @RequestParam String content) throws Exception {
	...
	public List<CommentDTO> commentList(Long review_no, Model model) throws Exception {
	...
	@ResponseBody
	public int commentUpdateProc(@RequestParam int cno, @RequestParam String content) throws Exception {
