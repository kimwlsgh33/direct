...
<div class="container">
	<form class="form-horizontal" method="post" action="${contextPath}/member/register">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<button class="idCheck btn" type="button" id="idCheck" onClick="fn_idCheck();" value="N">아이디 중복확인</button>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="reset"  class="btn">입력취소</button>
				<button type="button" class="btn cancel">회원가입 취소</button>
				<button type="submit" class="btn" id="submit">회원가입</button>
				<button type="submit" class="btn signUpBtn"  disabled="disabled">회원가입</button>
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
