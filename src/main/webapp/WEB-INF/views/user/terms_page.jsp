...
<html>
	...
	<jsp:include page="../common/header.jsp" flush="false" />
		...
		<div class="container bgi" id="bg">
            <form class="form-horizontal" method="post" action="/user/addTerms_page.do">
				...
				<div class="form-group terms_box">
					...
					<div>
						<input id="terms_status" type="hidden" name="terms_status" value="" />
					</div>
					<div align="center">
