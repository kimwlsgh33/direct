...
<%--                                <img src="${item.product_image}" /> --%>
                                ...
                                <div class="progress d-flex" style="width: 80%; margin-left: auto; margin-right: auto" >
                                    <div class="progress-bar progress-bar-striped bg-warning" style="width: 25%;" role="progressbar" aria-label="Basic example" aria-valuenow="ㅑㅅ0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
