...
<div class="bg-light h-75">
    ...
    <p>상품 옵션 : ${itemDTO.itemOptionVO.option}, ${itemDTO.itemOptionVO.price}, ${itemDTO.itemOptionVO.description}</p>
 ...
 <div align="center" class="container"><hr>
		<div class="row" id="border">
				...
				<div class="col-md-6">
					...
					<div style="text-align:left;">${itemDTO.itemVO.name}</div>
						<div style="text-align:right;">${itemDTO.itemVO.price}</div>
					<div id="border">
		...
		<div>
			...
			<div class="row" id="bdrt" style="padding:8px;">
				...
				<div class="col-sm-4" style="text-align:left;">${itemDTO.itemVO.item_id}</div>
			...
			<div class="row" id="bdrt" style="padding:8px;">
				...
				<div class="col-sm-4" style="text-align:left;">${itemDTO.itemVO.name}</div>
	...
	<div class="text-center">
  	   <c:forEach items="${itemDTO.imgList}" var="image">
			<img src="${image.img_url}" class="img-fluid" style="width:100%">
     	</c:forEach>
	</div>
	<div class="text-center">
  	   <c:forEach items="${itemDTO.imgList}" var="image">
