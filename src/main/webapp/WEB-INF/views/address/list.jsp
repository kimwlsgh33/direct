            ...
            <div style="margin-left: 20%; margin-top: 30px;">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4" style="margin-right: 110px;">
                        <a class="btn btn-sm btn-outline-success"
                           href="${contextPath}/address/new">배송지 추가</a>
                    </div>
                </div>
                <c:forEach var="addr" items="${addressList}">
                    <div class="form-group" style="margin-top: 50px;">
                        ...
                        <div class="col-md-8">
                            <input id="receiver" type="text" class="form-control" maxlength="20" value="${addr.receiver}" readonly/>
                        </div>
                        <label for="phone" class="form-label">연락처</label>
                        <div class="col-md-8">
                            <input id="phone" type="text" class="form-control" maxlength="20" value="${addr.addr_number}" readonly/>
                        </div>
                        <label for="address" class="form-label">주소</label>
                        <div class="col-md-8">
                            <input id="address" type="text" class="form-control" maxlength="20" value="${addr.address}" readonly/>
                        </div>
                    </div>
