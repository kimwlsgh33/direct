...
<div class="container">
	<div class="row">
		...
		<form class="row g-3" id="addr" style="margin-left: 30%;">
			<h2 class="col-sm-4" style="padding-top: 30px;">배송지 detail</h2>
			...
			<div class="form-group" style="margin-top: 50px;">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" name="receiver" id="receiver" value="${detail.receiver}"readonly/>
				</div>
			</div>
			<div class="form-group">
				<label class="form-label" style="text-align: right">연락처</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="phone" id="phone" value="${detail.phone}"readonly/>
				</div>
			</div>
			<div class="form-group">
