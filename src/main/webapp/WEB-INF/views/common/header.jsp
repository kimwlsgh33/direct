        ...
        <div class="w-50 ">
            <ul class="nav d-flex align-items-center justify-content-evenly">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle dropdown" id="dropDown" data-bs-toggle="dropdown" role="button" type="button"  href="#" aria-expanded="false"  style="color: black">Dropdown</a>
