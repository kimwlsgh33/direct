...
<div class="container bgi">
	<form class="form-horizontal" method="post" action="${contextPath}/member/addMember.do">
        ...
        <div class="form-group col-sm-6 shadow">
      	...
      	<div class="form-group col-sm-5">
      		<span class="input-group">
	            ...
	            <input type="text" class="form-control" id="phone" name="phone" maxlength="11" placeholder="Enter PHONE_NUMBER (without -)"/>
      		</span>
	    </div><br><br>
	    <div class="form-group col-sm-5">
	    	<span class="input-group">
  		...
  		<div class="form-group col-sm-4">
  			<span class="input-group">
				...
				<input type="button"	class="form-control pink" onclick="daumZipCode()" value="우편번호검색" />
  			</span>
		</div><br><br>
		...
		<img src="${contextPath}/resources/icons/logo.svg" width="300" height="240" class="float-end"/><br><br><br>
      	<div class="form-group buttons">
      		<button type="button" class="btn btnn" id="goHome">홈</button>
      		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
