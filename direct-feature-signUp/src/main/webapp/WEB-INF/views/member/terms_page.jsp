...
<html>
	...
	<jsp:include page="../common/header.jsp" flush="false" />
		...
		<div class="container bgi" id="bg">
			<form class="form-horizontal" method="post" action="/member/addTerms_page.do">
				...
				<div class="form-group terms_box">
					<font size="18" class="font">모두 동의&nbsp;&nbsp;<input type="checkbox" class="checkbox0 check" id="selectAll" value="selectAll" /></font>
	...
	function fn_termInfo() {
		...
		$.ajax({
			url:"/member/addTerms_page.do",
			type: "post",
			data: { "terms_status" : termsChoose },
		});
	};
