...
<html>
	<head>
		...
		<style>
			...
			.bgi {
				background-image: url(${contextPath}/resources/icons/logo.svg), url(${contextPath}/resources/icons/logo.svg);
	...
	<jsp:include page="./common/header.jsp" flush="false" />
		...
		<div class="container bgi" id="bg">
			<form class="form-horizontal" method="post" action="${contextPath}/member/addterms.do">
				...
				<div class="form-group terms_box">
					<font size="18" class="font">모두 동의&nbsp;&nbsp;<input type="checkbox" class="checkbox0" id="selectAll" value="selectAll" /></font><br><br><br><br>
					<ul>
						<li>
						...
						<li>
							<span class="span">광고 및 홍보성 알림 수신 동의  <b>(선택)</b>
								<font class="font">동의&nbsp;&nbsp;<input type="checkbox" class="checkbox" id="commercial" value="commercial" name="terms"/></font>
							</span><br><br>
							<div class="ssbox">
								<h5 class="sub">
						...
						<li>
							<span class="span">야간 ( 23시 ~ 08시 ) 알림 수신동의  <b>(선택)</b>
								<font class="font">동의&nbsp;&nbsp;<input type="checkbox" class="checkbox" id="night" value="night" name="terms"/></font>
							</span><br><br>
							<div class="ssbox">
								<h5 class="sub">
									<br><b>야간광고 전송제한 및 예외</b><br><br>
									법률 제50조(영리목적의 광고성 정보 전송 제한)<br>
					...
					<div align="center">
						<button type="button" class="btn btn-danger btnn"><b>가입 취소</b></button>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button type="submit" class="btn btnn" id="pink"><b>가입 완료</b></button><br><br>
					</div>
				</div>
			</form>
		</div>
